...
<p align="center">
  ...
  <img src="https://img.shields.io/github/downloads/microblue/myclaw-desktop-releases/total?color=%23027DEB" alt="Downloads" />
...
Download the latest release for your platform from the [Releases](https://github.com/microblue/myclaw-desktop-releases/releases) page.

#### Build from Source

```bash
# Clone the repository
git clone https://github.com/microblue/myclaw-desktop.git
cd MyClaw
