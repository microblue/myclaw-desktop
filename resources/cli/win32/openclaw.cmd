...
if /i "%1"=="update" (
    echo openclaw is managed by MyClaw ^(bundled version^).
    echo.
    echo To update openclaw, update MyClaw:
    echo   Open MyClaw ^> Settings ^> Check for Updates
...
set OPENCLAW_EMBEDDED_IN=MyClaw
